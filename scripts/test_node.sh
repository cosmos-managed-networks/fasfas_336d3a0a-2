...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.fasfas" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.fasfas" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.fasfas"}")
export BINARY=${BINARY:-fasdfsa}
export DENOM=${DENOM:-fsadfsda}
...
from_scratch () {
  ...
  # fsdaf1efd63aw40lxf3n4mhf7dzhjkr453axurx8uej7
  ...
  # fsdaf1hj5fveer5cjtn4wd6wstzugjfdxzl0xp6n0amh
